...
export async function renderHome(app) {
	...
	divCopy.classList.add("home__copy");
	const divSkills = document.createElement("div");
	divSkills.classList.add("home__skills");
	const divContact = document.createElement("div");
	divContact.classList.add("home__contact");

	divCopy.innerHTML = `
		<div class="home__copy--primary">
	...
	divContact.innerHTML = `
		...
		<div>
			<div>
				...
				<a href="https://www.linkedin.com/in/victoriadiro/" class="contact__linkedin" target="_blank">Victoria Díaz</a>
			</div>
			<div>
				<img src="../assets/icons/contact/github.png" alt="" class="">
				<a href="https://github.com/VictoriaDiro" class="contact__github" target="_blank">Victoria Diro</a>
			</div>
			<div>
				<img src="../assets/icons/contact/email.png" alt="" class="">
				<a href="mailto:victoriadiro01@gmail.com?subject=Contacto desde portfolio" class="contact__email" target="_blank">Victoria Díaz</a>
			</div>
		</div>
    `;
	...
	divSkills.appendChild(skillsSection);

	app.appendChild(divCopy);
	app.appendChild(divSkills);
	app.appendChild(divContact);
}
